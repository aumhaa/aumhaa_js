...
//borrowed from https://github.com/lahmatiy/es6-promise-polyfill/blob/master/promise.js

// var util = require('aumhaa_util');
// var task_server = require('aumhaa_task_server');
...
var NativePromise = undefined;
var nativePromiseSupported = false;
...
// Polyfill
//
// var Tasks = new task_server.TaskServer(this, 2);
//
// Tasks.addTask(function(){lcl_debug('tick2');}, {}, 100, true, 'tick');
//
// function setImmediate(func, interval){
//   debug('setImmediate', func);
//   Tasks.addTask(func, {}, interval, false);
// }
...
var asyncSetTimer = new Task(asyncFlush, this);
//asyncSettimer.interval = 1;
